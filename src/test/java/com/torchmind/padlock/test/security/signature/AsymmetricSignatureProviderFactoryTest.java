...
import com.torchmind.padlock.security.signature.AsymmetricSignatureProviderFactory;
...
/**
 * Provides test cases for {@link com.torchmind.padlock.security.signature.AsymmetricSignatureProviderFactory}
 * @author Johannes Donath
 */
@RunWith (MockitoJUnitRunner.class)
public class AsymmetricSignatureProviderFactoryTest {
        ...
        public void testBuild () {
                AsymmetricSignatureProviderFactory factory = new AsymmetricSignatureProviderFactory ("SHA1withRSA", this.rsaKey);

                AsymmetricSignatureProvider provider1 = factory.build ();
                AsymmetricSignatureProvider provider2 = factory.build ();
